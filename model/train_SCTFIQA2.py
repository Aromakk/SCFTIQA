...
from model.model_reference.transformer_IQA import VisionTransformer
from config import Config
from utils.process import RandCrop, ToTensor, RandHorizontalFlip, Normalize, five_point_crop, twenty_point_crop
from scipy.stats import spearmanr, pearsonr
from data.datain import DataIn
from torch.utils.tensorboard import SummaryWriter 
from tqdm import tqdm
from model.net import SCTF_Net
        ...
        for data in tqdm(test_loader):
            ...
            for i in range(config.num_avg_val):
                ...
                if config.num_avg_val == 5:
                    x_d, x_s = five_point_crop(i, d_img=x_d, s_img=x_s, config=config)
                else:
                    x_d, x_s = twenty_point_crop(i, d_img=x_d, s_img=x_s, config=config)
                # print("+=============")
                # print(type(x_d))
                # net_value = int(net(x_d)[0])
                # print(type(net(x_d)))
...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        # TID2013
        "db_name": "TID2013",
        "train_dis_path": "E:/Data/TID2013/Train",
        "train_sal_path": "E:/Data/TID2013/Train_sal_png",
        "val_dis_path": "E:/Data/TID2013/Test",
        "val_sal_path": "E:/Data/TID2013/Test_sal_png",
        "train_txt_file_name": "E:/Data/TID2013/train_TID2013.txt",
        "val_txt_file_name": "E:/Data/TID2013/test_TID2013.txt",
        ...
        "log_path": "./output/log/demo/",
        "log_file": ".txt",
        "tensorboard_path": "./output/tensorboard/",
        "model_path": "./output/models/epoch150"
    })
    ...
    # data load
    train_dataset = DataIn(
        dis_path=config.train_dis_path,
        sal_path=config.train_sal_path,
    ...
    for epoch in range(0, config.n_epoch):
        ...
        # 2022.9.1
        if hasattr(torch.cuda, 'enpty_cache'):
            torch.cuda.empty_cache()
        ...
        logging.info('Epoch {} doneSS. Time: {:.2}min'.format(epoch + 1, (time.time() - start_time) / 60))